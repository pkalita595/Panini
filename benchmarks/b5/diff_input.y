...
E : E '+' F	{
			...
			$$ = p; //store the last allocated ponter position
			p++;
...
char* get_fun_defs(int id,int is_first)
{
	...
	{
		sprintf(str,""
		"void add(int x,int y,ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _gen(x,y,2);  \n"
		...
		sprintf(str,""
		"void add2(int x,int y,ref int _out)\n"
        "{\n"
        "       _out =  x + y;\n"
        "}\n"
        "\n",fun_id);
	...
	if(1)
	{
		...
		"void sub(int x,int y,ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _gen(x,y,2);  \n"
		...
		sprintf(str+strlen(str),""
		"void sub2(int x,int y,ref int _out)\n"
        "{\n"
        "       _out =  x - y;\n"
        "}\n",fun_id);
        //takeSynFun(str, 2);
	...
	{
		sprintf(str+strlen(str),""
		"void mul(int x,int y,ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _gen(x,y,2);  \n"
        ...
        sprintf(str+strlen(str),""
		"void mul2(int x,int y,ref int _out)\n"
        "{\n"
        "       _out =  x * y;\n"
        "}\n",fun_id);
        //takeSynFun(str, 4);
	...
	{
		sprintf(str+strlen(str),""
		"void divide(int x,int y,ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _gen(x,y,2);  \n"
		...
		sprintf(str+strlen(str),""
		"void divide2(int x,int y,ref int _out)\n"
        "{\n"
        "       _out =  x / y;\n"
        "}\n",fun_id);
