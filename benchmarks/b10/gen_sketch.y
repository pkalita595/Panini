...
char* get_fun_defs(int id,int is_first)
{
	...
	if(curr_code % 2 == 1)
	{
		...
		"void subReal%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _gen(xReal, xDual, yReal, yDual,1);  \n"
	...
	{
		sprintf(str+strlen(str),""
		"void mulReal%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _gen(xReal, xDual, yReal, yDual,1);  \n"
	...
	{
		sprintf(str+strlen(str),""
		"void divideReal%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int  r = 0;\n"
        "       int bnd = 1;\n"
	...
	{
		sprintf(str+strlen(str),""
		"void powReal%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
	...
	{
		sprintf(str+strlen(str),""
		"void sinReal%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
    ...
    */
	...
	{
		sprintf(str+strlen(str),""
		"void cosReal%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _genFun(xReal, xDual, yReal, yDual,  2);  \n"
	...
	{
		sprintf(str+strlen(str),""
		"void addDual%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _gen(xReal, xDual, yReal, yDual, 1);  \n"
	...
	{
		sprintf(str+strlen(str),""
		"void subDual%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _gen(xReal, xDual, yReal, yDual,1);  \n"
	...
	{
		sprintf(str+strlen(str),""
		"void mulDual%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 2;\n"
	...
	{
		sprintf(str+strlen(str),""
		"void powDual%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
	...
	else
	{
		...
		"void powDual%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       _out =  xDual * yReal * pow(xReal, yReal - 1);;\n"
        "}\n",fun_id);
        */
	...
	{
		sprintf(str+strlen(str),""
		"void sinDual%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _genFun(xReal, xDual, yReal, yDual,  2);  \n"
	...
	{
		sprintf(str+strlen(str),""
		"void cosDual%s(int xReal, int xDual, int yReal, int yDual, ref int _out)\n"
        "{\n"
        "       int  p = 0;\n"
        "       int bnd = 1;\n"
        "       _out =  _genFun(xReal, xDual, yReal, yDual,  2);  \n"
