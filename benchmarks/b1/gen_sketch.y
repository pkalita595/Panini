...
int main(int argc,char **argv)
{
	...
	for(int i=2;i<=last_id;i++)
	{
        ...
        "generator int _gen(int x,int y,ref int[4] choices,ref int p,int bnd)\n"
        "{\n"
        "       assert bnd >= 0;\n"
        "       int t = ??;\n"
        "       int curr_p = p;\n"
        ...
        "       if(t == 0) {return x;}\n"
        "       if(t == 1) {return y;}\n"
        "       int a = _gen(x,y,choices,p,bnd-1);\n"
        "       int b = _gen(x,y,choices,p,bnd-1);      \n"
        "       if(t == 2) {return a + b;}\n"
        "       if(t == 3) {return a - b;}\n"
        "       if(t == 4) {return a * b;}\n"
        "       else {assert b !=0 ; choices[curr_p]=5; return a / b;}\n"
        "}\n"
        "\n"
        "\n"
