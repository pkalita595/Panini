...
#include <cstring>
#include <string>
#define  BIG_SIZE 10000    /* size of UNKNOWN array which is used by all the Fbars, array is devided  for each Fbar */
#define FUN_DEF_SIZE 1000  /* combined string length of one single Fbar interpreter functions */
#define ASSERT_STMT_SIZE 200 /* string length of assert statement */
#define FUN_STATE_SIZE 4	/*max number of decisions made for a single function inside the generator */
#define NUM_FUNS 4		/* number of functions */
...
%token <f>  NUM INR EUR USD
%type <f> E T F G H CURR C
